...
import { FileText, Calendar, CheckCircle2, XCircle, Clock, Trash2, CheckCircle, FileUp, Eye, User, ShieldCheck } from 'lucide-react';
...
const LeaveDetailModal: React.FC<LeaveDetailModalProps> = ({
  ...
  const loadVerifierInfo = async () => {
    try {
      ...
      const info = await leaveService.getVerifierInfo(leave.id);
