          ...
          {(isSubmissionOpen || isCollapsed) && (
            <div className={`mt-1 overflow-hidden transition-all duration-300 ${isCollapsed ? '' : 'max-h-96'}`}>
              <NavItem 
                ...
                label="Libur Mandiri" 
                indent 
                badge={(user?.is_hr_admin || user?.role === 'admin') ? pendingSubmissions['Libur Mandiri'] : 0} 
                activeTab={activeTab}
                setActiveTab={setActiveTab}
                isCollapsed={isCollapsed}
              />
              <NavItem 
                ...
                label="Lembur" 
                indent 
                badge={(user?.is_hr_admin || user?.role === 'admin') ? pendingSubmissions['Lembur'] : 0} 
                activeTab={activeTab}
                setActiveTab={setActiveTab}
                isCollapsed={isCollapsed}
              />
              <NavItem 
                ...
                label="Izin" 
                indent 
                badge={(user?.is_hr_admin || user?.role === 'admin') ? pendingSubmissions['Izin'] : 0} 
                activeTab={activeTab}
                setActiveTab={setActiveTab}
                isCollapsed={isCollapsed}
              />
              <NavItem 
                ...
                label="Cuti Tahunan" 
                indent 
                badge={(user?.is_hr_admin || user?.role === 'admin') ? pendingSubmissions['Cuti Tahunan'] : 0} 
                activeTab={activeTab}
                setActiveTab={setActiveTab}
                isCollapsed={isCollapsed}
              />
              {(user?.gender === 'Perempuan' || user?.role === 'admin' || user?.is_hr_admin) && (
                <NavItem 
                  ...
                  indent 
                  badge={(user?.is_hr_admin || user?.role === 'admin') ? pendingSubmissions['Cuti Melahirkan'] : 0} 
                  activeTab={activeTab}
                  setActiveTab={setActiveTab}
                  isCollapsed={isCollapsed}
                />
              ...
              <NavItem 
                ...
                label="Presensi Luar" 
                indent 
                badge={(user?.is_hr_admin || user?.role === 'admin') ? pendingSubmissions['Presensi Luar'] : 0} 
                activeTab={activeTab}
                setActiveTab={setActiveTab}
                isCollapsed={isCollapsed}
              />
